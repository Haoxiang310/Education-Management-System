  ...
  export default {
    ...
    methods: {
      ...
      getClass(index,row){
        ...
        this.$router.push({
          path:'/university_administration_index/university_administration_classInfo',
          query:{
            CourseName:row.name,
          }
        })
      ...
      getAllGrade(index,row){
        console.log(row.name);
        this.$router.push({
          path:'/university_administration_index/university_administration_course_grade',
          query:{
            CourseName:row.name,
          }
        })
      ...
      getCourses(){
        axios({
          methods: 'get',
          url: 'http://222.28.46.89:8080/EduManagementSystem_war3/adminIndex/getAdminByAdminId',
          params: {

            'adminId':localStorage.getItem("adminId" ),
          },
        }).then((res)=>{
          localStorage.setItem("adminSchool",res.data.adminSchool );
        });
        axios({
          methods: 'get',
